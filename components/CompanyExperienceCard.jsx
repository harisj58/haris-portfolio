...
import { ArrowRight, MapPin, Calendar, Briefcase, ExternalLink } from "lucide-react";
import { getDurationFromString, formatDuration, getTotalCompanyDuration } from "../utils/dateUtils";
      ...
      <div className="company-header">
        ...
        <div className="company-info">
          ...
          <div className="company-roles-count">
            ...
            {totalDurationText && (
              <span className="company-total-duration"> • {totalDurationText} total</span>
            )}
          </div>
          {companyUrl && (
            <a
            ...
            <div key={experience.id} className="role-item">
              ...
              <div className="role-header">
                ...
                <div className="role-meta">
                  <div className="role-meta-item">
                    ...
                    {experience.duration}
                    {roleDurationText && (
                      <span className="role-duration-calculated"> ({roleDurationText})</span>
                    )}
                  </div>
                  <div className="role-meta-item">
                    <MapPin size={12} />
              ...
              <div className="role-skills">
                ...
                {experience.skills.length > 8 && (
                  <span className="role-skill-tag">+{experience.skills.length - 8}</span>
                )}
              </div>

              <div className="role-actions">
                <Link href={`/experience/${experience.id}`} className="role-link">
